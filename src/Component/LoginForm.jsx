...
export default function LoginForm() {
  ...
  // Generic handler — phone field strips non-digits and enforces 10-char max
  ...
  const handleEmailSubmit = (e) => {
    ...
    if (!formData.email.trim()) {
      ...
      // Strict @gmail.com validation as required
      newErrors.email = "Only Gmail addresses are accepted (e.g. you@gmail.com)";
    }
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4" noValidate>
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-slate-700 mb-1.5">
                Email <span className="text-slate-400 font-normal text-xs">(Gmail only)</span>
              </label>
          ...
          <form onSubmit={handleOtpSubmit} className="space-y-4" noValidate>
            <div>
              <label htmlFor="mobile" className="block text-sm font-medium text-slate-700 mb-1.5">
                Mobile number <span className="text-slate-400 font-normal text-xs">(10 digits)</span>
              </label>
              <div className="relative">
              ...
              {formData.mobile.length > 0 && formData.mobile.length < 10 && !errors.mobile && (
                <p className="mt-1 text-xs text-slate-400">{10 - formData.mobile.length} more digits needed</p>
              )}
            </div>
            ...
            {!otpSent ? (
              ...
              <>
                ...
                <button
                  ...
                  className="w-full rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold py-2.5 transition"
                >
                  {submitted ? "✓ Verified!" : "Verify & Log In"}
                </button>
              </>
            )}
          </form>
